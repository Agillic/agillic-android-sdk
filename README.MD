...
[![](https://jitpack.io/v/agillic/agillic-android-sdk.svg)](https://jitpack.io/#agillic/agillic-android-sdk)
...
```bash
dependencies {
    implementation 'com.github.agillic:agillic-android-sdk:0.2.6'
}
```
