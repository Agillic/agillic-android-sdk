...
Most SDK functions accepts a callback parameter which can be added in order to gain information on what's happening in the SDK and when. See the following example:
